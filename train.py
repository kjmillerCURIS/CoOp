...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.COCOOP_ENSEMBLING_LAIONIZED_FIXED_CLASSNAME = CN()
    cfg.TRAINER.COCOOP_ENSEMBLING_LAIONIZED_FIXED_CLASSNAME.PREC = "fp16"  # fp16, fp32, amp
    cfg.TRAINER.COCOOP_ENSEMBLING_LAIONIZED_FIXED_CLASSNAME.RANDOM_CTX_INIT = False
    cfg.TRAINER.COCOOP_ENSEMBLING_LAIONIZED_FIXED_CLASSNAME.TRAIN_SEPARATELY = False
    cfg.TRAINER.COCOOP_ENSEMBLING_LAIONIZED_FIXED_CLASSNAME.ONETOKEN = False
    cfg.TRAINER.COCOOP_ENSEMBLING_LAIONIZED_FIXED_CLASSNAME.NOPERIOD = False
    cfg.TRAINER.COCOOP_ENSEMBLING_LAIONIZED_FIXED_CLASSNAME.LAION_NUM_POSITIVES = 1
    cfg.TRAINER.COCOOP_ENSEMBLING_LAIONIZED_FIXED_CLASSNAME.LAION_LAMBDA = 1.0
    cfg.TRAINER.COCOOP_ENSEMBLING_LAIONIZED_FIXED_CLASSNAME.GRAMLEN = 1
    cfg.TRAINER.COCOOP_ENSEMBLING_LAIONIZED_FIXED_CLASSNAME.FILTER_OUT_TEXT_ON_LAION_IMAGES = False
