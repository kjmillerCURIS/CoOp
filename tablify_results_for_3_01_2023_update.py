...
NAME_DICT = {'ZeroshotCLIP2' : 'ZeroshotCLIP w/prompt ensembling', 'CLIPAdapter' : 'CLIPAdapter (alpha=0.2 (default))', 'CLIPAdapter_alpha0_5' : 'CLIPAdapter (alpha=0.5)', 'CLIPAdapter_alpha0_8' : 'CLIPAdapter (alpha=0.8)'}
