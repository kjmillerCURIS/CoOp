...
def tablify_results_for_4_26_2023_update(experiment_dirs, table_prefix):
...
if __name__ == '__main__':
    table_dir = '../vislang-domain-exploration-data/CoCoOpExperiments/baselines/tables_for_4_26_2023_update'
    exp_base_dir = '../vislang-domain-exploration-data/CoCoOpExperiments/baselines'

    #Idea #2 without and with cleaning
    tablify_results_for_4_26_2023_update([os.path.join(exp_base_dir, exp) for exp in ['ZeroshotCLIP', 'ZeroshotCLIP2', 'CoCoOp', 'CoCoOpEnsembling_random_separate_onetokennoperiod', 'CoCoOpEnsemblingLAIONizedFixedClassname_gramlen1', 'CoCoOpEnsemblingLAIONizedFixedClassname_gramlen3', 'CoCoOpEnsemblingLAIONizedFixedClassname_gramlen5', 'CoCoOpEnsemblingLAIONizedFixedClassname_gramlen1_FilterImageText', 'CoCoOpEnsemblingLAIONizedFixedClassname_gramlen3_FilterImageText', 'CoCoOpEnsemblingLAIONizedFixedClassname_gramlen5_FilterImageText']], os.path.join(table_dir, 'laion_idea2_clean'))
