...
def tablify_results_for_4_12_2023_update(experiment_dirs, table_prefix):
...
if __name__ == '__main__':
    table_dir = '../vislang-domain-exploration-data/CoCoOpExperiments/baselines/tables_for_4_12_2023_update'
    exp_base_dir = '../vislang-domain-exploration-data/CoCoOpExperiments/baselines'


    #Idea #1
    tablify_results_for_4_12_2023_update([os.path.join(exp_base_dir, exp) for exp in ['ZeroshotCLIP', 'ZeroshotCLIP2', 'CoCoOp', 'CoCoOpEnsembling_random_separate_onetokennoperiod', 'CoCoOpEnsemblingLAIONized_gramlen1', 'CoCoOpEnsemblingLAIONized_gramlen3', 'CoCoOpEnsemblingLAIONized_gramlen5']], os.path.join(table_dir, 'laion_idea1'))


    #Idea #2
    tablify_results_for_4_12_2023_update([os.path.join(exp_base_dir, exp) for exp in ['ZeroshotCLIP', 'ZeroshotCLIP2', 'CoCoOp', 'CoCoOpEnsembling_random_separate_onetokennoperiod', 'CoCoOpEnsemblingLAIONized_gramlen1', 'CoCoOpEnsemblingLAIONized_gramlen3', 'CoCoOpEnsemblingLAIONized_gramlen5', 'CoCoOpEnsemblingLAIONizedFixedClassname_gramlen1', 'CoCoOpEnsemblingLAIONizedFixedClassname_gramlen3', 'CoCoOpEnsemblingLAIONizedFixedClassname_gramlen5']], os.path.join(table_dir, 'laion_idea2'))
