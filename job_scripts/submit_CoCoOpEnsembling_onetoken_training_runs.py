...
#                        for onetoken_type in ['onetoken', 'onetokennoperiod']:
                        for onetoken_type in ['onetokennoperiod']:
                            ...
                            job_name = 'CoCoOpEnsembling_%s_%s_%s_train_fs%d_ds%d_cs%s'%(random_or_manual, separate_or_together, onetoken_type, fewshot_seed, domain_split_index, class_split_type)
