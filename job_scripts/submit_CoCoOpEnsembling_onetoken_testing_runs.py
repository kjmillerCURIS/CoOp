...
#                        for onetoken_type in ['onetoken', 'onetokennoperiod']:
                        for onetoken_type in ['onetokennoperiod']:
                            ...
                            for eval_type in ['seen_domains_seen_classes', 'seen_domains_unseen_classes', 'unseen_domains_seen_classes', 'unseen_domains_unseen_classes']:
                                ...
                                job_name = 'CoCoOpEnsembling_%s_%s_%s_test_fs%d_ds%d_cs%s_et%s'%(random_or_manual, separate_or_together, onetoken_type, fewshot_seed, domain_split_index, class_split_type, eval_type) 
