    ...
    for class_split_type in ['random', 'ordered']:
        for seed in [0]:
            ...
            for domain_split_index in range(6):
                ...
                my_cmd = 'qsub -N %s -v CLASS_SPLIT_TYPE=%s,SEED=%d,FEWSHOT_SEED=%d,DOMAIN_SPLIT_INDEX=%d,OUTPUT_DIR=%s run_CLIPAdapter_train_generic.sh'%(job_name,class_split_type,seed,fewshot_seed,domain_split_index,output_dir)
...
if __name__ == '__main__':
    submit_CLIPAdapter_training_runs()
