...
def submit_CoCoOp_testing_runs_record_examples():
        ...
        for fewshot_seed in [2]:
            ...
            for domain_split_index in range(6):
                ...
                for eval_type in ['seen_domains_seen_classes', 'seen_domains_unseen_classes', 'unseen_domains_seen_classes', 'unseen_domains_unseen_classes']:
                    ...
                    job_name = 'CoCoOp_test_ex_fs%d_ds%d_cs%s_et%s'%(fewshot_seed, domain_split_index, class_split_type, eval_type) 
                    ...
                    script_name = 'run_CoCoOp_test_record_examples.sh'
...
if __name__ == '__main__':
    submit_CoCoOp_testing_runs_record_examples()
